    ...
    <div className="space-y-6" data-testid="documents-page">
        ...
        {canManageDocuments && (
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            <DialogTrigger asChild>
              <Button data-testid="upload-document-button">
            ...
            <DialogContent className="max-w-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <Button type="submit" disabled={uploading} data-testid="submit-document-button">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredDocuments.map((document) => {
          ...
          return (
            <Card key={document.id} className="p-6 card-hover" data-testid={`document-card-${document.id}`}>
              <div className="space-y-4">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">{document.employee_name}</p>
                  </div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {document.expiry_date && (
                    <div>
                      ...
                      <p className={`font-mono font-medium ${
                        isExpired ? 'text-rose-500' : isExpiringSoon ? 'text-amber-500' : ''
                      }`}>
                        {document.expiry_date}
                        {isExpired && ' (Expired)'}
                  ...
                  <div>
                    ...
                    <p className="font-mono text-xs">{new Date(document.uploaded_at).toLocaleDateString()}</p>
                  </div>
                </div>
